...
<div class="col-2" style="float: left">
    <div class="text-left" style=background-color:lavender>学生姓名：</div>
    <div clas="text-left" style=background-color:lavender>学号：</div>
    <div clas="text-left" style=background-color:lavender>GPA：</div>
    <div clas="text-left" style=background-color:lavender>总学分：</div>
</div>
